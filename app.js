...
window.onload = function() {
  ...
  function openFilters() {
    jQuery(".find-alumni--filters-block").slideToggle();
    jQuery(".overlay-bg").toggle();
  }
  function countFilterPosition() {
    const searchHeight = $(".find-alumni--search").css("height");
    $(".find-alumni--filters-block").css("top", searchHeight);
  }
  ...
  jQuery(".find-alumni--search-filters").click(() => openFilters());
